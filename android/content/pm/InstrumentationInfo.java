 ...
 * instrumentation. This corresponds to information collected from the
...
public class InstrumentationInfo extends PackageItemInfo implements Parcelable {
	...
	/**
	 * Full path to the publicly available parts of {@link #sourceDir}, including
	 * resources and manifest. This may be different from {@link #sourceDir} if an
	 * application is forward locked.
	 */
	public String publicSourceDir;

	/**
	 * Full paths to zero or more split APKs that, when combined with the base APK
	 * defined in {@link #sourceDir}, form a complete application.
	 */
